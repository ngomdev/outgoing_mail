...
return [
    ...
    'profiles' => [
        ...
        'custom' => [
            'plugins' => 'accordion autoresize codesample directionality advlist autolink link image lists charmap preview anchor pagebreak searchreplace wordcount visualblocks visualchars code fullscreen insertdatetime media table help',
            'toolbar' => 'customInsertButton fullscreen undo redo | forecolor backcolor | fontFamily | fontSize | bold italic underline | alignjustify alignright aligncenter alignleft | numlist bullist outdent indent accordion | blockquote table toc hr | image link anchor | print preview wordcount help',
            'upload_directory' => null,
        ],
    ],
