...
class SetPassword extends SimplePage
{
    ...
    protected static string $view = 'filament.pages.auth.password-reset';
    ...
    protected function getPasswordFormComponent(): Component
    {
        return TextInput::make('password')
            ...
            ->required()
            ->rule(PasswordRule::default()->mixedCase()->symbols())
    ...
    {
        return __("Définition mot de passe");
    }

    public function getHeading(): string | Htmlable
    {
        return __("Définissez votre mot de passe");
    }
