...
<head>
    ...
    <title>Notification Ajout Collaborateur</title>
    <!--[if (mso 16)]>
<style type="text/css">
                        ...
                        <tr style="border-collapse:collapse">
                            <td cellpadding="0" cellspacing="0" border="0"
                                style="padding:0;Margin:0;line-height:1px;min-width:600px" height="0"><img
                                    src="https://yigojw.stripocdn.email/content/guids/CABINET_837dc1d79e3a5eca5eb1609bfe9fd374/images/41521605538834349.png"
            ...
            <tr style="border-collapse:collapse">
                <td valign="top" style="padding:0;Margin:0">
                    <table class="es-header" cellspacing="0" cellpadding="0" align="center"
                        ...
                        <tr style="border-collapse:collapse">
                            <td align="center" bgcolor="#f4cb33" style="padding:0;Margin:0;background-color:#f4cb33">
                    ...
                    <table class="es-content" cellspacing="0" cellpadding="0" align="center"
                        ...
                        <tr style="border-collapse:collapse">
                            <td style="padding:0;Margin:0;background-color:#f4cb33" bgcolor="#f4cb33" align="center">
                                                                ...
                                                                <td class="es-m-txt-l" bgcolor="#ffffff"
                                                                    ...
                                                                    @if ($contract->is_avenant)
                                                                        <p
                                                                            ...
                                                                            Vous venez d'être ajouté au contrat
                                                                            {{ $contract->title }}, avenant du contrat
                                                                            {{ $contract->parentContract->title }}
                                                                            en tant que
                                                                            {{ $contract_profile_name }}.<br />
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        en tant que
                                                                        {{ $contract_profile_name }}.<br />
                                                                        Cliquez sur le bouton ci-dessous pour accéder au
                                                                        contrat.</p>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
...
style="height:54px; v-text-anchor:middle; width:235px" arcsize="4%" strokecolor="#ffa73b" strokeweight="1px" fillcolor="#f4cb33">
<w:anchorlock></w:anchorlock>
<center style='color:#ffffff; font-family:helvetica, "helvetica neue", arial, verdana, sans-serif; font-size:20px; font-weight:400; line-height:20px; mso-text-raise:1px'>Accéder au Contrat</center>
</v:roundrect></a>
<![endif]-->
                                                                    <!--[if !mso]><!-- --><span
                                                                        class="msohide es-button-border"
                                                                        style="border-style:solid;border-color:#FFA73B;background:#f4cb33;border-width:1px;display:inline-block;border-radius:2px;width:auto;mso-hide:all"><a
                                                                            href="{{ url('/contracts/' . $contract->id) }}"
                                                                            class="es-button es-button-1"
                                                                            target="_blank"
                                                                            style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#FFFFFF;font-size:20px;border-style:solid;border-color:#f4cb33;border-width:15px 30px;display:inline-block;background:#f4cb33;border-radius:2px;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;font-weight:normal;font-style:normal;line-height:24px;width:auto;text-align:center">Accéder
                                                                            au Contrat</a></span>
                                                                    <!--<![endif]-->
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                                <td class="es-m-txt-l" align="left"
                                                                    ...
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:27px;color:#666666;font-size:18px">
                                                                        Si vous avez des difficultés à cliquer sur le
                                                                        bouton "Accéder au contrat", copiez et collez
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td class="es-m-txt-l" align="left"
                                                                    ...
                                                                    <a target="_blank"
                                                                        href="{{ url('/contracts/' . $contract->id) }}"
                                                                        style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#f4cb33;font-size:18px">
                                                                        {{ url('/contracts/' . $contract->id) }}</a>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                                <td class="es-m-txt-l" align="left"
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        © 2022 {{ config('app.name') }}. Tous droits
                                                                        réservés.
                                                                    </p>
                                                                </td>
                                                            </tr>
