...
use App\Filament\Resources\SettingModule\CourierSettingResource\Pages\ManageCourierSettings;

class CourierSettingResource extends Resource
{
    protected static ?string $model = Setting::class;
    protected static ?int $navigationSort = 1;
    protected static ?string $slug = 'settings/couriers';
    protected static ?string $navigationLabel = 'Courriers';
    protected static ?string $modelLabel = 'Paramètre courriers';
    protected static ?string $pluralModelLabel = 'Paramètres courriers';
    ...
    {
        return [
            'index' => ManageCourierSettings::route('/'),
        ];
    }
    ...
    public static function getEloquentQuery(): Builder
    {
        return parent::getEloquentQuery()
            ->where('module', SettingModule::COURIER);
    }
}
