<div>
    @if ($document && $this->isVisible())
        <div class="sm:mt-7">
            <x-filament::modal slide-over sticky-header width="3xl">
                <x-slot name="trigger">
                    <x-filament::button icon="heroicon-m-arrow-path" outlined>
                        Historique
                ...
                <x-slot name="heading">
                    Historique doc. <span class="text-primary-600">{{ $document->name }} - v{{ $version }}</span>
                </x-slot>
                ...
                <div>
                    ...
                    @if ($activities->isNotEmpty() && $this->isCollapsible)
                        <div class="flex justify-end gap-x-3">
                            <x-filament::link color="gray" tag="button" size="sm"
                    ...
                    <div class="space-y-4">
                        ...
                        @if ($activities->isNotEmpty())
                            <x-filament::pagination :page-options="$this->getTableRecordsPerPageSelectOptions()" :paginator="$this->getActivities()" class="px-3 py-3 sm:px-6" />
                        @endif
                    </div>
