...
use App\Filament\Resources\SettingModule\SystemSettingResource\Pages\ManageSystemSettings;
...
class SystemSettingResource extends Resource
{
    ...
    protected static ?string $modelLabel = 'Paramètre système';
    protected static ?string $pluralModelLabel = 'Paramètres système';
    ...
    public static function getEloquentQuery(): Builder
    {
        return parent::getEloquentQuery()
            ->where('module', SettingModule::SYSTEM);
    }
}
